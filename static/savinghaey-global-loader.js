...
(function () {
  ...
  function ensureStyle() {
    const hasStyle = !!document.querySelector('link[href*="/static/savinghaey-style.css"]');
    if (hasStyle) return;

    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "/static/savinghaey-style.css?v=" + VERSION;
  ...
  function ensureBrandStack() {
    ...
    return ensureScript("/static/savinghaey-config.js").then(function () {
      return ensureScript("/static/savinghaey-ui.js", { defer: "" });
    });
  }
  ...
  function applyProtection() {
    ...
    // savinghaey-config.js에서 copyProtection: false면 보호 기능 전체 비활성화
